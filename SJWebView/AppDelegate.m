...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    NSURL *url = [NSURL URLWithString:@"www.equarter.cn/platformWebService/web/index.htm"];
    
    

    self.webViewController = [[TOWebViewController alloc] initWithURL:url];
